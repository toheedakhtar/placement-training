            ...
            <form onSubmit={handleSubmit(onSubmit)}>
                <div className='grid grid-cols-2 gap-5 my-5 '>
                    ...
                    <div>
                        ...
                        <input type='file' className='p-2 py-1 border border-gray-800 outline-none bg-transparent my-3' {...register("productImage")} />
                    </div>

                </div>
                <button className='bg-black text-white text-xs p-2 active:bg-gray-800'>Add Product</button>
            </form>
          </Box>
