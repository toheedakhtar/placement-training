...
import { addProduct, updateProductWithImage, updateProduct } from '../redux/slices/productSlice';
      ...
      >
        ...
        <Box>
          <form onSubmit={handleSubmit(onSubmit)}>
              ...
              <button className='bg-black text-white text-xs p-2 active:bg-gray-800'>{isUpdate ? "Update Product" : "Add Product"}</button>
          </form>
        </Box>
